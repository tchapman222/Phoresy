 ...
 * OVR/Configure Custom Build                   Configures a build based on the tags specified in Assets/SampleScenes/OVRHarness/BuildConfig.asset
 */
public class AutopopulateSceneNames : AssetPostprocessor
{
	private static readonly string SCENE_FILE_PATH = "/SampleScenes/OVRHarness/Resources/scenes.txt";
    private static readonly string STARTUP_SCENE_PATH = "Assets/SampleScenes/OVRHarness/Scenes/StartUp.unity";
	private static readonly string LOADING_SCENE_PATH = "Assets/SampleScenes/OVRHarness/Scenes/Loading.unity";
